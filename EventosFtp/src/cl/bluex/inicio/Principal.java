 ...
 * The Class Principal.
 * 
 * Proceso que busca archivos tipo Eventos desde ftp por empresas,
 * los descarga a carpetas locales, los procesa en CTRT.
...
public class Principal {
	...
	public static void main(final String[] args) throws IOException {
		...
		LOGGER.info("[eventos] Obteniendo parametros generales");
